...
## Project Structure
    ...
    ├── testapiautosetting_125110  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125110`
...
2. Clone this repo and `cd testapiautosetting_125110`
